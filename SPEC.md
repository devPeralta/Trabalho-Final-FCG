...
## Exemplos de Aplicações Gráficas desenvolvidas por alunos em semestres anteriores podem ser vistos na seguinte playlist do YouTub:

    Playlist - Trabalhos de Fundamentos de Computação Gráfica - INF/UFRGS
...
Nas aulas de laboratório dos dias 11 e 18 de novembro de 2025, o professor irá passar por cada dupla no laboratório para que a dupla apresente uma a versão em desenvolvimento do trabalho final, já compilando e executando, que já implemente alguns dos requisitos listados acima.

## Apresentação Final

Cada dupla irá apresentar seu trabalho para a turma nas aulas dos dias 2 e 4 de dezembro de 2025. O tempo de apresentação é de no máximo 7 minutos por dupla. A ordem de apresentações se dará por sorteio nestes mesmos dias. A apresentação pode consistir em um conjunto de slides (opcional) e obrigatoriamente deve conter a demonstração da aplicação funcionando. Para isso a dupla pode utilizar o computador principal do laboratório ou conectar seu notebook pessoal no projetor. Se sua dupla for utilizar o computador do laboratório, traga seu código fonte e binário compilado em um pen-drive, para facilitar a cópia dos dados antes da apresentação.
Entrega
...
Um dos integrantes da dupla deve fazer envio no Moodle de um arquivo ZIP com o seguinte conteúdo:
    ...
    Código fonte completo documentado;
        ...
        Lembre-se que os testes de colisão devem ser implementados em um arquivo à parte, nomeado "collisions.cpp".
    ...
    Um vídeo de 3 a 5 minutos com uma apresentação do trabalho feito pela dupla, incluindo uma demonstração da aplicação gráfica. Para gravar seu vídeo, você pode usar o software OBS Studio. Preferencialmente, você deve incluir um link para o vídeo no Youtube dentro do seu ZIP (vídeo público ou "unlisted"). Se você não quiser usar o Youtube por algum motivo, pode incluir o vídeo no formato MP4 dentro do ZIP (com compressão adequada).

A entrega deve ser feita impreterivelmente até 23 horas e 55 minutos do dia 5 de dezembro de 2025 (sexta-feira), utilizando o botão "Adicionar tarefa" abaixo.

Caso necessário, separe seus arquivos ZIP em partes de 16 MB cada. O Moodle aceita upload de até 20 arquivos de 16 MB, por aluno.
